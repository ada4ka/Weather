...
const Weather = () => {
  return (
   ...
   <img src="" alt="" className="main-card-icon" />
   <h2 className="main-card-temperature">22℃ </h2>
   <div className="main-card-function">
    <img src="" alt="" className="main-card-function-reload" />
    <img src="" alt="" className="main-card-function-like" />
    <button className="main-card-function-more"></button>
    <img src="" alt="" className="main-card-function-delete" />
   </div>
    </main>
  );
};
